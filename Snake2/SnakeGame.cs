...
namespace Snake2
{
    ...
    class SnakeGame
    {
        ...
        {
            if (direccio == DireccioSnake.Avall) capSerp.Y++;
            else if (direccio == DireccioSnake.Amunt) capSerp.Y--;
            else if (direccio == DireccioSnake.Dreta) capSerp.X++;
            else if (direccio == DireccioSnake.Esquerre) capSerp.X--;
        }
    }
}
